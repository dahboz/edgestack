        ...
        <main className="min-h-screen flex justify-center py-10 px-2"> 
             <div className="w-full md:w-90 md:max-h-140 rounded shadow-md py-5 px-4">
                ...
                <div className="mt-2 flex justify-center">
                    ...
                    <div className="px-5 py-5 flex flex-col gap-4 wt-8 w-80 h-60 shadow rounded-md">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <p className="text-gray-600 text-xs">+2347033221019</p>
                        </div>
                  ...
                  className="mt-5">
                    <button className="bg-red-500 text-white w-30 h-10 shadow cursor-pointer rounded
